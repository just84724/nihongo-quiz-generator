...
export const enTranslations: Translations = {
  ...
  grq2_chinese: "Mother buys candy for me",
  grq3_chinese: "Mr. Takano teaches me English",
  grq4_chinese: "The electronics store person brings a new TV for me",
  grq5_chinese: "The district office person tells us how to get there",
  grq6_chinese: "That old man fixes shoes for my sister",
  grq7_chinese: "The travel agency person applies for overseas travel visa for my family",
  grq8_chinese: "Mr. Wang teaches Mr. Takeuchi work methods",
  grq9_chinese: "I tell you the homework answers",
  grq10_chinese: "Mother buys toys for my brother",
  grq11_chinese: "Mr. Wang plays guitar for his girlfriend",
  grq12_chinese: "The teacher lends beautiful picture books to classmates",
  grq13_chinese: "The dormitory manager puts mail in everyone's mailbox",
  grq14_chinese: "Mr. Kishibe teaches me guitar",
  grq15_chinese: "A friend helped me buy books",
  grq16_chinese: "My brother helps me clean the room",
  grq17_chinese: "The travel agency person helps me book a hotel",
  grq18_chinese: "His wife makes lunch boxes for him",
  grq19_chinese: "Her boyfriend helps her pay for meals",
  grq20_chinese: "Mr. Lin teaches Mr. Tamura Chinese",
  ...
  avq1_chinese: "The bus left.",
  avq2_chinese: "(It) was erased.",
  avq3_chinese: "Missed the bus.",
  avq4_chinese: "(I) have a headache.",
  avq5_chinese: "(I) dropped my wallet.",
  avq6_chinese: "Fell into the water.",
  avq7_chinese: "(It) was eaten.",
  avq8_chinese: "(I) forgot.",
  avq9_chinese: "Should we park the car in the parking lot?",
  avq10_chinese: "Let's think carefully before doing it!",
  avq11_chinese: "Please close the door properly.",
  avq12_chinese: "Let those who want to talk speak!",
  avq13_chinese: "Let's assume the name is Tanaka for now.",
  avq14_chinese: "Buy sweets before guests come.",
  avq15_chinese: "Tidy up the room before guests come.",
  avq16_chinese: "Prepare meals before guests come.",
  avq17_chinese: "Clean up before guests come.",
  avq18_chinese: "Take luggage outside before guests come.",
  avq19_chinese: "Try watching a movie.",
  avq20_chinese: "Try it out.",
  avq21_chinese: "Let's try eating!",
  avq22_chinese: "Let's try drinking!",
  avq23_chinese: "Let's try looking for it!",
  avq24_chinese: "Let's try our best!",
  avq25_chinese: "You won't know without trying to go.",
  avq26_chinese: "You won't know without trying to read.",
  avq27_chinese: "You won't know without trying to research.",
  avq28_chinese: "The ship entered the port.",
  avq29_chinese: "The problem became complicated.",
  avq30_chinese: "Has been talking until now.",
  avq31_chinese: "Various problems appeared.",
  avq32_chinese: "It started to rain.",
  avq33_chinese: "Go get the forgotten item.",
  avq34_chinese: "Father returned from Japan yesterday.",
  avq35_chinese: "It will get hotter and hotter.",
  avq36_chinese: "I'll go buy a book and come back.",
  avq37_chinese: "He went back to Japan.",
  avq38_chinese: "Will live alone.",
  avq39_chinese: "Humans will die.",
  avq40_chinese: "The weather will get warmer and warmer.",
  avq41_chinese: "(I) will continue working after marriage.",
  avq42_chinese: "The car gradually moved away.",
  avq43_chinese: "(I) will work even harder from now on.",
  avq44_chinese: "The body will become stronger and stronger.",
  avq45_chinese: "I want to continue studying Japanese.",
