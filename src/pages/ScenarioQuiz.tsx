...
const scenarioQuestions: ScenarioQuestion[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      "B：好，到時見。",
      "（廣播裡播報：飛機即將降落，請乘客做好準備。今天時間是7月15號，星期五，室外溫度35攝氏度。祝旅途愉快。）"
    ],
    dialogueEn: [
    ...
    answer: [
      ...
      "B：好，到時見。",
      "はい、約束（やくそく）します。。。",
      "（廣播裡播報：飛機即將降落，請乘客做好準備。今天時間是7月15號，星期 五，室外溫度35攝氏度。祝旅途愉快。）"
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    dialogue: [
      ...
      "A：我哪裡都沒去呢。平常就一個人在家。偶爾週末和爸媽去公園玩。",
      "B：聽起來也不錯啦。",
    ...
    answer: [
      ...
      "A：我哪里都沒去呢。平常就一個人在家。偶爾週末和爸媽去公園玩。",
